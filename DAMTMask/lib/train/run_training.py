...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
                 ...
                 distill=None, script_teacher=None, config_teacher=None, stage1_model=None, mixformer_model = None):
    ...
    settings.mixformer_model = mixformer_model
...
def main():
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 stage1_model=args.stage1_model,mixformer_model = args.mixformer_model)
