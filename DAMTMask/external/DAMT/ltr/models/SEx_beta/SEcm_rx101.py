...
@model_constructor
def SEcm_resnext101(backbone_pretrained=True, used_layers=('layer3',), pool_size=None, unfreeze_layer3=False):
    # backbone
    # backbone_net = backbones.resnet34(pretrained=backbone_pretrained)
    backbone_net = backbones.resnext101_32x8d(pretrained=backbone_pretrained)
