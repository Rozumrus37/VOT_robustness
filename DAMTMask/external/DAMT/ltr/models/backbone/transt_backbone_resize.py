...
class CVTSegmBackbone(nn.Module):
    ...
    def __init__(self,
        ...
        from .mixformer_seg_resize import get_mixformer_model
        # TODO: pretrained
...
def build_backbone_resize(settings, backbone_pretrained=True, frozen_backbone_layers=(), use_large_backbone = False):
