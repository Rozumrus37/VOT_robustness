...
def _resnet(
    ...
    **kwargs: Any
    ...
    model = ResNet(block, layers, use_dilated, **kwargs)
    if pretrained:
...
def resnext50_32x4d(output_layers=None, pretrained: bool = False, progress: bool = True, use_dilated: bool = False, **kwargs: Any) -> ResNet:
    ...
    kwargs['output_layers'] = output_layers
    return _resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3],
                   pretrained, progress,use_dilated, **kwargs)


def resnext101_32x8d(output_layers=None, pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
