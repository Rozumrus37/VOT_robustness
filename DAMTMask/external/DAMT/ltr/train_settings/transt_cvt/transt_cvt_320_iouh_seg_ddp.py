...
def run(settings):
    ...
    settings.responses = False

    # pretrained_transt
    settings.freeze_transt = True
    settings.transt_cvt_path = '/home/tiger/tracking_code/transt_mask_cvt/work_dirs/checkpoints/ltr/transt_cvt/transt_cvt_320_iouh_ddp/TransTCVTiouh_ep0090.pth.tar'
