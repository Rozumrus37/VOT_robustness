...
def run(settings):
    ...
    settings.transt_cvt_path = None #'/home/tiger/tracking_code/transt_mask_cvt/networks/TransTCVTiouhsegm_ep0120.pth.tar'
    ...
    trainer.train(90, transt_path=settings.transt_cvt_path, load_latest=True, fail_safe=True)
