...
def run(settings):
    ...
    settings.transt_cvt_path = '/home/tiger/tracking_code/transt_mask_cvt/work_dirs/checkpoints/ltr/transt_cvt/transt_cvt_iouh_ddp/TransTCVTiouh_ep0082.pth.tar'
    ...
    # trackingnet_train = TrackingNet(settings.env.trackingnet_dir, set_ids=list(range(7)))
    ...
    # dataset_train = sampler.TransTMaskSampler([lasot_train,got10k_train,trackingnet_train,coco_train], [1,1,1,1],
    #                                           num_search_frames=1, num_template_frames=2,
    ...
    trainer.train(120, transt_path=settings.transt_cvt_path, load_latest=True, fail_safe=True)
