...
import ltr.models.segm.transt_init as transt_models
...
def run(settings):
    ...
    settings.center_jitter_factor = {'search': 1.5, 'static_template': 0, 'dynamic_template': 0.25}
    ...
    #settings.transt_path = '/home/cx/cx1/TransT_experiments/models/e464e90.pth'
    settings.transt_path = '/home/tiger/tracking_code/transt_mask_cvt/work_dirs/checkpoints/ltr/transt_cvt/transt_cvt_only_seg_ddp/TransTCVTiouhsegm_ep0120.pth.tar'
    ...
    dataset_train = sampler.TransTMaskSampler([youtube_vos,saliency,ovis,youtube_vis], [1,1,1,1],
                                              num_search_frames=1, num_template_frames=2,
                                              samples_per_epoch=8*200*settings.batch_size, max_gap=100,
    ...
    actor = actors.TranstActorSegm(net=model, objective=objective, settings=settings)
