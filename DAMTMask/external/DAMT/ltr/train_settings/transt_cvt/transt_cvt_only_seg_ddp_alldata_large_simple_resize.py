...
def run(settings):
    ...
    settings.center_jitter_factor = {'search': 0.5, 'static_template': 0, 'dynamic_template': 0.25}
    ...
    dataset_train = sampler.TransTMaskSampler([youtube_vos,saliency,ovis,youtube_vis], [2,3,2,2],
                                              ...
                                              samples_per_epoch=64*200*settings.batch_size, max_gap=100,
    ...
    model = transt_models.transt_cvt_large_resize(settings)
