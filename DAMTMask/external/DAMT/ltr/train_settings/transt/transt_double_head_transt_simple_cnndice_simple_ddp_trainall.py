...
def run(settings):
    ...
    settings.cnn_path = '/home/tiger/tracking_code/MixFormer/external/transt_mask_cvt/work_dirs/checkpoints/ltr/transt/transt_double_head_cnn_ddp_lr-3_simple/ResSegm_ep0120.pth.tar'
    ...
    settings.loss_bce_weight_cnn = 1
