...
def sample_target_SE_with_mask(im, target_bb, mask, search_area_factor, output_sz=None, mode=cv.BORDER_REPLICATE):
    ...
    mask_crop_padded = cv.copyMakeBorder(mask_crop, y1_pad, y2_pad, x1_pad, x2_pad,
